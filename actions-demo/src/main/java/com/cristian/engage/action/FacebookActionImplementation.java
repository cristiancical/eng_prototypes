...
public class FacebookActionImplementation {
		
	public static String sendComment(String resourceId, String comment) {
		System.out.println(String.format("Dummy action: Send comment %s to resource:%s", comment, resourceId));
		return "message";
	}
